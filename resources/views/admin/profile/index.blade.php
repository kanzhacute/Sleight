      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-10 col-md-10">
            <h1 class="display-2 text-white">Kenalin, {{ Auth::user()->name }}</h1>
            <p class="text-white mt-0 mb-5">owner dari Djiwa Sorria. Kebetulan, saya masih mahasiswi di Institut Teknologi Telkom Surabaya.</p>
          </div>
        </div>
      </div>
    </div>
